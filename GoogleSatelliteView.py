...
__author__ = "mamiruzz"
__date__ = "$Jan 16, 2018 6:44:53 PM$"
...
GOOGLE_MAPS_API_KEY = "AIzaSyDtg4UBLsMiVlnvFXy7HueEPLWypTQj2h4"  # set to 'your_API_key'
...
def get_maps_image(NW_lat_long, SE_lat_long, zoom=18):
    ...
    for x in range(cols):
        for y in range(rows):
          ...
          ######print lat, lng value in a txt file
            
            xyposition = "{0}, {1}, {2}\n".format(x, y, position)
            with open("Output.txt", "a") as text_file:
                text_file.write("%s" % xyposition)
